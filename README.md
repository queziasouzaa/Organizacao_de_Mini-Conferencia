O arquivo ordenação de conferencia.py é um script Python desenvolvido para organizar o cronograma de uma miniconferência. Ele executa as seguintes funções principais:
